---
title: "ARREND - Contador"
author: "[2026]"
output: 
  flexdashboard::flex_dashboard:
    logo: arrend-logo.png
    orientation: rows
...
#Importación   --------------------------------------------------------
data <- read_sheet("1pKDXpeAjmI5PNV2pqJpfF4GhdrbeiEGwAzv-fOkpyX0")
principal <- read_sheet("1JdXePk-Fj7I-R39-uoDSvYKB6qrDQ0uHzKxlzawLfHQ")
...
layout_column_wrap(
  ...
  card_body(
   contador_area %>% 
    hchart("bar", hcaes(x = pais, y = total_prop, z = total_respuestas), name = "Población", showInLegend = TRUE,
           borderRadius = 10,
           dataLabels=list(enabled=TRUE, format="{point.z:.0f}")) %>%
    hc_add_series(type = "bar",data = contador_area,hcaes(x = pais, y = prop_Completado, z = respuestas_Completado),
